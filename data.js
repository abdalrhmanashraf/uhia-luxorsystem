...
var STATIC_DATA = {
  ...
  questions: {
    ...
    // == الأسئلة الختامية (تُعرض في نهاية الاستبيان) ==
    final: [
      {
        code: 'Q_GEN_04',
        type: 'yesno',
      ...
      },
      {
        code: 'Q_GEN_05_NOTES',
        type: 'textarea',
        text: 'ملاحظات أو اقتراحات إضافية (اختياري)',
        hint: 'أضف أي ملاحظات خاصة بالاستبيان هنا',
        options: []
      }
    ],
...
// ─── أهداف المستشفيات (KPI Targets) ───
var HOSPITAL_TARGETS = {
  'مستشفى إيزيس التخصصي': {
    total_monthly: 5787,
    sample: 579,
    breakdown: {
      'المستشفيات - العيادات الخارجية': 405,
      'المستشفيات - أقسام الطوارئ': 87,
      'المستشفيات - الأقسام الداخلية': 87
    }
  },
  'مستشفى الأطفال التخصصي': {
    ...
    sample: 837,
    breakdown: {
      'المستشفيات - العيادات الخارجية': 586,
      'المستشفيات - أقسام الطوارئ': 126,
      'المستشفيات - الأقسام الداخلية': 125
    }
  },
  'المجمع الطبي الدولي': {
    total_monthly: 35759,
    sample: 3576,
    breakdown: {
      'المستشفيات - العيادات الخارجية': 2503,
      'المستشفيات - أقسام الطوارئ': 536,
      'المستشفيات - الأقسام الداخلية': 537
    }
  },
  'مستشفى طيبة التخصصي': {
    total_monthly: 29814,
    sample: 2981,
    breakdown: {
      'المستشفيات - العيادات الخارجية': 2087,
      'المستشفيات - أقسام الطوارئ': 447,
      'المستشفيات - الأقسام الداخلية': 447
    }
  },
  'مستشفى حورس التخصصي': {
    total_monthly: 27257,
    sample: 2726,
    breakdown: {
      'المستشفيات - العيادات الخارجية': 1908,
      'المستشفيات - أقسام الطوارئ': 409,
      'المستشفيات - الأقسام الداخلية': 409
    }
  },
  'مستشفى الكرنك الدولي': {
    ...
    sample: 3034,
    breakdown: {
      'المستشفيات - العيادات الخارجية': 2124,
      'المستشفيات - أقسام الطوارئ': 455,
      'المستشفيات - الأقسام الداخلية': 455
    }
  }
};
